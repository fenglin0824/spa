var $={
	...
	ajax:function(obj){
		...
		/*2.获取请求的类型，如果没有传递请求方式，那么默认为get*/
		var type=obj.type || 'get';
		/*3、获取请求的url location.pathname:就是指当前请求发起的路劲*/
		...
		/*6.2:设置请求行，判断请求类型，一次决定是否需要拼接参数到url*/
		if(type=='get'){
			url=url+"?"+data;
			/*重置参数，为post请求简化处理*/
			data=null;
		...
		xhr.onreadystatechange=function(){
			...
			if(xhr.status==200&&xhr.readyState==4){
				/*客户端可用的响应结果*/
				var result=null;
				//获取响应Content-type--类型是字符串
				var grc=xhr.getAllResponseHeaders("Content-Type");
